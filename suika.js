(function () {
  ...
  var FRUIT_NAMES = ["Cherry","Strawberry","Grape","Lemon","Orange","Apple","Pear","Peach","Pineapple","Melon","Watermelon"];

  var GRAVITY = 2200;
  var RESTITUTION = 0.2;
  var FRICTION = 0.35;
  var CONTACT_FRICTION = 0.97;
  var BEST_KEY = "suikaver_best";
  var GAMES_KEY = "suikaver_games";
  var DEATH_Y = 40;
  var REST_MS = 1000;
  ...
  function endGame() {
    ...
    if (statsEl) {
      statsEl.innerHTML = '<span class="chip">🍉 merges: ' + totalMerges + '</span>' +
        ...
        '<span class="chip">🏆 watermelons: ' + watermelons + '</span>';
    }
